...
class TaskService:
    def create_task(self, task_id, task_data): return {"id": task_id, **task_data}
    def get_task(self, task_id): return {"id": task_id, "status": "unknown"}
    def update_task(self, task_id, updates): return {"id": task_id, **updates}
    def list_tasks(self, user_id): return []
