...
Drop-in replacement for the OANDA version — identical response models,
...
# ── Pydantic models (identical to OANDA version — Flutter side unchanged) ──────
...
# ── Main service (identical signature to OANDA version) ───────────────────────
...
async def get_market_prices(
    ...
    Flow:
      ...
      3. Cache miss → call Twelve Data /price (batch)
